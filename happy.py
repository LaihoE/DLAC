...
class DataMover():
    ...
    def get_pos_player(self, steamid,main_folder):
        ...
        with open(f"{main_folder}{self.MatchId}.csv",'w',newline='\n')as f:
            ...
            thewriter.writerow(['ActiveWeapon', 'AreaId', 'AreaName', 'Armor', 'DistToBombsiteA',
    ...
    def split_df_by_kill(self,steamid,out_folder,write_to_csv=False):
        """
        :param attacker_name:
...
#X = datamover.split_df_by_kill('76561198134270402', r"D:\Users\emill\singlekills", write_to_csv=True)